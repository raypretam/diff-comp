...
# Bracket-augmented NeCTI training — Finegrain granularity
# 56 compound types × bracket classes in joint label space.

echo "========================================"
echo "NeCTI Bracket Training (Finegrain)"
...
python -m trainers.trainer_necti_bracket \
    --config_file necti_bracket_finegrain.yaml \
